    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="w-[95%] px-6 py-12 mx-auto shadow-lg">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-3">
          ...
          <div className="flex max-md:flex-row gap-16 w-full">
            <div>
              ...
              <div className="flex flex-col items-start mt-5 space-y-2">
                <a
                  href="#"
                  className="text-gray-600 transition-colors duration-300 text-xl dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500"
                >
                  Home
                </a>
                <a
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex -mx-2">
            <a
              href="#"
              className="mx-2 text-gray-600 transition-colors duration-300 text-xl dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400"
              aria-label="Reddit"
            >
              <svg
